...
IF_DEF(SVE_BH_3B_A, IS_NONE, NONE) // SVE_BH_3B_A  ...........mmmmm ....hhnnnnnddddd  -- SVE address generation
...
IF_DEF(SVE_BO_1A_A, IS_NONE, NONE) // SVE_BO_1A_A  ...........Xiiii ......pppppddddd  -- SVE saturating inc/dec register by element count
...
IF_DEF(SVE_BV_2A_A, IS_NONE, NONE) // SVE_BV_2A_A  ........xx..gggg ..hiiiiiiiiddddd  -- SVE copy integer immediate (predicated)
IF_DEF(SVE_BV_2B,   IS_NONE, NONE) // SVE_BV_2B  ........xx..gggg ...........ddddd  -- SVE copy integer immediate (predicated)
IF_DEF(SVE_BV_2A_J, IS_NONE, NONE) // SVE_BV_2A_J  ........xx..gggg ..hiiiiiiiiddddd  -- SVE copy integer immediate (predicated)
...
IF_DEF(SVE_BZ_3A_A, IS_NONE, NONE) // SVE_BZ_3A_A  ........xx.mmmmm ......nnnnnddddd  -- SVE table lookup (three sources)
...
IF_DEF(SVE_CX_4A_A, IS_NONE, NONE) // SVE_CX_4A_A  ........xx.mmmmm ...gggnnnnn.DDDD  -- SVE integer compare vectors
...
IF_DEF(SVE_CZ_4A_K, IS_NONE, NONE) // SVE_CZ_4A_K  ............MMMM ..gggg.NNNN.DDDD  -- SVE predicate logical operations
IF_DEF(SVE_CZ_4A_L, IS_NONE, NONE) // SVE_CZ_4A_L  ............MMMM ..gggg.NNNN.DDDD  -- SVE predicate logical operations
IF_DEF(SVE_CZ_4A_A, IS_NONE, NONE) // SVE_CZ_4A_A  ............MMMM ..gggg.NNNN.DDDD  -- SVE predicate logical operations
...
IF_DEF(SVE_DO_2A_A, IS_NONE, NONE) // SVE_DO_2A_A  ........xx...... .....X.MMMMddddd  -- SVE saturating inc/dec register by predicate count
...
IF_DEF(SVE_GH_3B_B, IS_NONE, NONE) // SVE_GH_3B_B  ........ii.mmmmm ......nnnnnddddd  -- SVE2 lookup table with 4-bit indices and 16-bit element size
...
IF_DEF(SVE_GY_3B_D, IS_NONE, NONE) // SVE_GY_3B_D  ...........iimmm ......nnnnnddddd  -- SVE BFloat16 floating-point dot product (indexed)
...
IF_DEF(SVE_HA_3A_E, IS_NONE, NONE) // SVE_HA_3A_E  ...........mmmmm ......nnnnnddddd  -- SVE BFloat16 floating-point dot product
IF_DEF(SVE_HA_3A_F, IS_NONE, NONE) // SVE_HA_3A_F  ...........mmmmm ......nnnnnddddd  -- SVE BFloat16 floating-point dot product
...
IF_DEF(SVE_HD_3A_A, IS_NONE, NONE) // SVE_HD_3A_A  ...........mmmmm ......nnnnnddddd  -- SVE floating point matrix multiply accumulate
...
IF_DEF(SVE_HO_3A_B, IS_NONE, NONE) // SVE_HO_3A_B  ................ ...gggnnnnnddddd  -- SVE floating-point convert precision
...
IF_DEF(SVE_HP_3B_H, IS_NONE, NONE) // SVE_HP_3B_H  ................ ...gggnnnnnddddd  -- SVE floating-point convert to integer
IF_DEF(SVE_HP_3B_I, IS_NONE, NONE) // SVE_HP_3B_I  ................ ...gggnnnnnddddd  -- SVE floating-point convert to integer
IF_DEF(SVE_HP_3B_J, IS_NONE, NONE) // SVE_HP_3B_J  ................ ...gggnnnnnddddd  -- SVE floating-point convert to integer
...
IF_DEF(SVE_HS_3A_H, IS_NONE, NONE) // SVE_HS_3A_H  ................ ...gggnnnnnddddd  -- SVE integer convert to floating-point
IF_DEF(SVE_HS_3A_I, IS_NONE, NONE) // SVE_HS_3A_I  ................ ...gggnnnnnddddd  -- SVE integer convert to floating-point
IF_DEF(SVE_HS_3A_J, IS_NONE, NONE) // SVE_HS_3A_J  ................ ...gggnnnnnddddd  -- SVE integer convert to floating-point
...
IF_DEF(SVE_HW_4A_A, IS_NONE, NONE) // SVE_HW_4A_A  .........h.mmmmm ...gggnnnnnttttt  -- SVE 32-bit gather load (scalar plus 32-bit unscaled offsets)
IF_DEF(SVE_HW_4B,   IS_NONE, NONE) // SVE_HW_4B  ...........mmmmm ...gggnnnnnttttt  -- SVE 32-bit gather load (scalar plus 32-bit unscaled offsets)
IF_DEF(SVE_HW_4A_B, IS_NONE, NONE) // SVE_HW_4A_B  .........h.mmmmm ...gggnnnnnttttt  -- SVE 32-bit gather load (scalar plus 32-bit unscaled offsets)
IF_DEF(SVE_HW_4A_C, IS_NONE, NONE) // SVE_HW_4A_C  .........h.mmmmm ...gggnnnnnttttt  -- SVE 32-bit gather load (scalar plus 32-bit unscaled offsets)
IF_DEF(SVE_HW_4B_D, IS_NONE, NONE) // SVE_HW_4B_D  ...........mmmmm ...gggnnnnnttttt  -- SVE 32-bit gather load (scalar plus 32-bit unscaled offsets)
IF_DEF(SVE_HX_3A,   IS_NONE, NONE) // SVE_HX_3A  ...........iiiii ...gggnnnnnttttt  -- SVE 32-bit gather load (vector plus immediate)
IF_DEF(SVE_HX_3A_B, IS_NONE, NONE) // SVE_HX_3A_B  ...........iiiii ...gggnnnnnttttt  -- SVE 32-bit gather load (vector plus immediate)
IF_DEF(SVE_HX_3A_E, IS_NONE, NONE) // SVE_HX_3A_E  ...........iiiii ...gggnnnnnttttt  -- SVE 32-bit gather load (vector plus immediate)
...
IF_DEF(SVE_HY_3A_A, IS_NONE, NONE) // SVE_HY_3A_A  .........h.mmmmm ...gggnnnnn.oooo  -- SVE 32-bit gather prefetch (scalar plus 32-bit scaled offsets)
...
IF_DEF(SVE_HZ_2A_B, IS_NONE, NONE) // SVE_HZ_2A_B  ...........iiiii ...gggnnnnn.oooo  -- SVE 32-bit gather prefetch (vector plus immediate)
...
IF_DEF(SVE_IC_3A_A, IS_NONE, NONE) // SVE_IC_3A_A  ..........iiiiii ...gggnnnnnttttt  -- SVE load and broadcast element
IF_DEF(SVE_IC_3A_B, IS_NONE, NONE) // SVE_IC_3A_B  ..........iiiiii ...gggnnnnnttttt  -- SVE load and broadcast element
IF_DEF(SVE_IC_3A_C, IS_NONE, NONE) // SVE_IC_3A_C  ..........iiiiii ...gggnnnnnttttt  -- SVE load and broadcast element
...
IF_DEF(SVE_IF_4A_A, IS_NONE, NONE) // SVE_IF_4A_A  ...........mmmmm ...gggnnnnnttttt  -- SVE2 32-bit gather non-temporal load (vector plus scalar)
IF_DEF(SVE_IG_4A,   IS_NONE, NONE) // SVE_IG_4A  ...........mmmmm ...gggnnnnnttttt  -- SVE contiguous first-fault load (scalar plus scalar)
IF_DEF(SVE_IG_4A_C, IS_NONE, NONE) // SVE_IG_4A_C  ...........mmmmm ...gggnnnnnttttt  -- SVE contiguous first-fault load (scalar plus scalar)
IF_DEF(SVE_IG_4A_D, IS_NONE, NONE) // SVE_IG_4A_D  ...........mmmmm ...gggnnnnnttttt  -- SVE contiguous first-fault load (scalar plus scalar)
IF_DEF(SVE_IG_4A_E, IS_NONE, NONE) // SVE_IG_4A_E  ...........mmmmm ...gggnnnnnttttt  -- SVE contiguous first-fault load (scalar plus scalar)
IF_DEF(SVE_IG_4A_F, IS_NONE, NONE) // SVE_IG_4A_F  ...........mmmmm ...gggnnnnnttttt  -- SVE contiguous first-fault load (scalar plus scalar)
IF_DEF(SVE_IG_4A_G, IS_NONE, NONE) // SVE_IG_4A_G  ...........mmmmm ...gggnnnnnttttt  -- SVE contiguous first-fault load (scalar plus scalar)
IF_DEF(SVE_IH_3A,   IS_NONE, NONE) // SVE_IH_3A  ............iiii ...gggnnnnnttttt  -- SVE contiguous load (quadwords, scalar plus immediate)
IF_DEF(SVE_IH_3A_F, IS_NONE, NONE) // SVE_IH_3A_F  ............iiii ...gggnnnnnttttt  -- SVE contiguous load (quadwords, scalar plus immediate)
IF_DEF(SVE_IH_3A_G, IS_NONE, NONE) // SVE_IH_3A_G  ............iiii ...gggnnnnnttttt  -- SVE contiguous load (quadwords, scalar plus immediate)
IF_DEF(SVE_IH_3A_A, IS_NONE, NONE) // SVE_IH_3A_A  ............iiii ...gggnnnnnttttt  -- SVE contiguous load (quadwords, scalar plus immediate)
IF_DEF(SVE_II_4A,   IS_NONE, NONE) // SVE_II_4A  ...........mmmmm ...gggnnnnnttttt  -- SVE contiguous load (quadwords, scalar plus scalar)
IF_DEF(SVE_II_4A_H, IS_NONE, NONE) // SVE_II_4A_H  ...........mmmmm ...gggnnnnnttttt  -- SVE contiguous load (quadwords, scalar plus scalar)
IF_DEF(SVE_II_4A_I, IS_NONE, NONE) // SVE_II_4A_I  ...........mmmmm ...gggnnnnnttttt  -- SVE contiguous load (quadwords, scalar plus scalar)
IF_DEF(SVE_II_4A_B, IS_NONE, NONE) // SVE_II_4A_B  ...........mmmmm ...gggnnnnnttttt  -- SVE contiguous load (quadwords, scalar plus scalar)
IF_DEF(SVE_IJ_3A,   IS_NONE, NONE) // SVE_IJ_3A  ............iiii ...gggnnnnnttttt  -- SVE contiguous load (scalar plus immediate)
IF_DEF(SVE_IJ_3A_C, IS_NONE, NONE) // SVE_IJ_3A_C  ............iiii ...gggnnnnnttttt  -- SVE contiguous load (scalar plus immediate)
IF_DEF(SVE_IJ_3A_D, IS_NONE, NONE) // SVE_IJ_3A_D  ............iiii ...gggnnnnnttttt  -- SVE contiguous load (scalar plus immediate)
IF_DEF(SVE_IJ_3A_E, IS_NONE, NONE) // SVE_IJ_3A_E  ............iiii ...gggnnnnnttttt  -- SVE contiguous load (scalar plus immediate)
IF_DEF(SVE_IJ_3A_F, IS_NONE, NONE) // SVE_IJ_3A_F  ............iiii ...gggnnnnnttttt  -- SVE contiguous load (scalar plus immediate)
IF_DEF(SVE_IJ_3A_G, IS_NONE, NONE) // SVE_IJ_3A_G  ............iiii ...gggnnnnnttttt  -- SVE contiguous load (scalar plus immediate)
IF_DEF(SVE_IK_4A,   IS_NONE, NONE) // SVE_IK_4A  ...........mmmmm ...gggnnnnnttttt  -- SVE contiguous load (scalar plus scalar)
IF_DEF(SVE_IK_4A_F, IS_NONE, NONE) // SVE_IK_4A_F  ...........mmmmm ...gggnnnnnttttt  -- SVE contiguous load (scalar plus scalar)
IF_DEF(SVE_IK_4A_G, IS_NONE, NONE) // SVE_IK_4A_G  ...........mmmmm ...gggnnnnnttttt  -- SVE contiguous load (scalar plus scalar)
IF_DEF(SVE_IK_4A_H, IS_NONE, NONE) // SVE_IK_4A_H  ...........mmmmm ...gggnnnnnttttt  -- SVE contiguous load (scalar plus scalar)
IF_DEF(SVE_IK_4A_I, IS_NONE, NONE) // SVE_IK_4A_I  ...........mmmmm ...gggnnnnnttttt  -- SVE contiguous load (scalar plus scalar)
IF_DEF(SVE_IK_4A_E, IS_NONE, NONE) // SVE_IK_4A_E  ...........mmmmm ...gggnnnnnttttt  -- SVE contiguous load (scalar plus scalar)
IF_DEF(SVE_IL_3A,   IS_NONE, NONE) // SVE_IL_3A  ............iiii ...gggnnnnnttttt  -- SVE contiguous non-fault load (scalar plus immediate)
IF_DEF(SVE_IL_3A_A, IS_NONE, NONE) // SVE_IL_3A_A  ............iiii ...gggnnnnnttttt  -- SVE contiguous non-fault load (scalar plus immediate)
IF_DEF(SVE_IL_3A_B, IS_NONE, NONE) // SVE_IL_3A_B  ............iiii ...gggnnnnnttttt  -- SVE contiguous non-fault load (scalar plus immediate)
IF_DEF(SVE_IL_3A_C, IS_NONE, NONE) // SVE_IL_3A_C  ............iiii ...gggnnnnnttttt  -- SVE contiguous non-fault load (scalar plus immediate)
...
IF_DEF(SVE_IU_4A_A, IS_NONE, NONE) // SVE_IU_4A_A  .........h.mmmmm ...gggnnnnnttttt  -- SVE 64-bit gather load (scalar plus 32-bit unpacked scaled offsets)
...
IF_DEF(SVE_IU_4B_B, IS_NONE, NONE) // SVE_IU_4B_B  ...........mmmmm ...gggnnnnnttttt  -- SVE 64-bit gather load (scalar plus 32-bit unpacked scaled offsets)
IF_DEF(SVE_IU_4A_C, IS_NONE, NONE) // SVE_IU_4A_C  .........h.mmmmm ...gggnnnnnttttt  -- SVE 64-bit gather load (scalar plus 32-bit unpacked scaled offsets)
IF_DEF(SVE_IU_4B_D, IS_NONE, NONE) // SVE_IU_4B_D  ...........mmmmm ...gggnnnnnttttt  -- SVE 64-bit gather load (scalar plus 32-bit unpacked scaled offsets)
...
IF_DEF(SVE_IZ_4A_A, IS_NONE, NONE) // SVE_IZ_4A_A  ...........mmmmm ...gggnnnnnttttt  -- SVE2 32-bit scatter non-temporal store (vector plus scalar)
...
IF_DEF(SVE_JD_4C_A, IS_NONE, NONE) // SVE_JD_4C_A  ...........mmmmm ...gggnnnnnttttt  -- SVE contiguous store (scalar plus scalar)
...
IF_DEF(SVE_JI_3A_A, IS_NONE, NONE) // SVE_JI_3A_A  ...........iiiii ...gggnnnnnttttt  -- SVE 32-bit scatter store (vector plus immediate)
IF_DEF(SVE_JJ_4A,   IS_NONE, NONE) // SVE_JJ_4A  ...........mmmmm .h.gggnnnnnttttt  -- SVE 64-bit scatter store (scalar plus 64-bit scaled offsets)
IF_DEF(SVE_JJ_4A_B, IS_NONE, NONE) // SVE_JJ_4A_B  ...........mmmmm .h.gggnnnnnttttt  -- SVE 64-bit scatter store (scalar plus 64-bit scaled offsets)
IF_DEF(SVE_JJ_4A_C, IS_NONE, NONE) // SVE_JJ_4A_C  ...........mmmmm .h.gggnnnnnttttt  -- SVE 64-bit scatter store (scalar plus 64-bit scaled offsets)
IF_DEF(SVE_JJ_4A_D, IS_NONE, NONE) // SVE_JJ_4A_D  ...........mmmmm .h.gggnnnnnttttt  -- SVE 64-bit scatter store (scalar plus 64-bit scaled offsets)
IF_DEF(SVE_JJ_4B,   IS_NONE, NONE) // SVE_JJ_4B  ...........mmmmm ...gggnnnnnttttt  -- SVE 64-bit scatter store (scalar plus 64-bit scaled offsets)
IF_DEF(SVE_JJ_4B_E, IS_NONE, NONE) // SVE_JJ_4B_E  ...........mmmmm ...gggnnnnnttttt  -- SVE 64-bit scatter store (scalar plus 64-bit scaled offsets)
IF_DEF(SVE_JJ_4B_C, IS_NONE, NONE) // SVE_JJ_4B_C  ...........mmmmm ...gggnnnnnttttt  -- SVE 64-bit scatter store (scalar plus 64-bit scaled offsets)
...
IF_DEF(SVE_JK_4A_B, IS_NONE, NONE) // SVE_JK_4A_B  ...........mmmmm .h.gggnnnnnttttt  -- SVE 64-bit scatter store (scalar plus 64-bit unscaled offsets)
...
IF_DEF(SVE_JN_3C_D, IS_NONE, NONE) // SVE_JN_3C_D  ............iiii ...gggnnnnnttttt  -- SVE contiguous store (scalar plus immediate)
